<?php
    ...
    $sql = "SELECT c.Cultivo_apodo, c.Cultivo_imagen, tc.Tipo_nombre ,c.Cultivo_id  FROM cultivo AS c INNER JOIN Tipo_cultivo AS tc ON c.Tipo_id = tc.Tipo_id WHERE c.Cultivo_estado = 1 AND c.Usuario_id =  " . $_GET["Usuario_id"];
